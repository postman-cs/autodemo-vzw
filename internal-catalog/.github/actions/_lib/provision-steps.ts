...
export const PROVISION_STEP_NAMES = {
  ...
  ONBOARD_INSIGHTS_DISCOVERY: "Onboard Insights Discovered Service",
...
export const PROVISION_SSE_STEPS: readonly ProvisionSseStep[] = [
  ...
  {
    name: PROVISION_STEP_NAMES.REFRESH_K8S_CONFIG_MAP,
    description: "Refreshing Kubernetes dependency ConfigMap for environment targets",
    phase: "aws",
  },
  {
  ...
  {
    name: PROVISION_STEP_NAMES.ONBOARD_INSIGHTS_DISCOVERY,
    description: "Linking Insights discovered service to workspace and repo",
    phase: "sync",
  },
  {
