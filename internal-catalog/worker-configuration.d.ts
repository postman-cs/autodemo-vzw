/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.toml` (hash: 9fd3392f8397bf6c754e5874134768d6)
// Runtime types generated with workerd@1.20260312.1 2026-02-09 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		ASSETS: Fetcher;
		GITHUB_TARGET_ORG: "postman-cs";
		AUTH_ENABLED: "true";
		CF_ACCESS_TEAM_DOMAIN: "jaredboynton";
		CF_ACCESS_AUD: "39305cc07e7e408132c3e9f3b37dbba5f11926fc0849f5b9e4114ff388fc9af7";
		WORKER_ORIGIN: "https://se.pm-catalog.dev";
		CF_ACCESS_CLIENT_ID: string;
		CF_ACCOUNT_ID: string;
		AWS_ACCESS_KEY_ID: string;
		AWS_SECRET_ACCESS_KEY: string;
		AWS_REGION: string;
		PROVISION_GRAPH_WORKFLOW: Workflow<Parameters<import("./src/index").ProvisionGraphWorkflow['run']>[0]['payload']>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_TARGET_ORG" | "AUTH_ENABLED" | "CF_ACCESS_TEAM_DOMAIN" | "CF_ACCESS_AUD" | "WORKER_ORIGIN" | "CF_ACCESS_CLIENT_ID" | "CF_ACCOUNT_ID" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY" | "AWS_REGION">> {}
}
